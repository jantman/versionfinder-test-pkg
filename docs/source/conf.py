# -*- coding: utf-8 -*-
#
# versionfinder-test-pkg documentation build configuration file, created by
...
from versionfinder_test_pkg.version import VERSION
...
project = u'versionfinder-test-pkg'
...
if is_rtd:
    ...
    htmlhelp_basename = 'versionfinder-test-pkgdoc'
...
latex_documents = [
  (master_doc, 'versionfinder-test-pkg.tex', u'versionfinder-test-pkg Documentation',
...
man_pages = [
    (master_doc, 'versionfinder-test-pkg', u'versionfinder-test-pkg Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'versionfinder-test-pkg', u'versionfinder-test-pkg Documentation',
   author, 'versionfinder-test-pkg', 'One line description of project.',
   'Miscellaneous'),
]
...
linkcheck_ignore = [
    ...
    r'https?://codecov\.io.*',
    r'https?://.*readthedocs\.org.*',
    r'https?://pypi\.python\.org/pypi/versionfinder-test-pkg'
]
